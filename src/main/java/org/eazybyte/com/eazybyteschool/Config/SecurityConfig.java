...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf((csrf) -> csrf.ignoringRequestMatchers("/saveMsg", "/displayMessages", "/closeMsg"))
...
//        return http.build();
    ...
    public InMemoryUserDetailsManager userDetailsService() {
        ...
        UserDetails user = User.withDefaultPasswordEncoder()
                ...
                .roles("USER")
                .build();
        UserDetails REDACTED = User.withDefaultPasswordEncoder()
                .username("REDACTED")
                .password("54321")
                .roles("USER", "ADMIN")
                .build();
        return new InMemoryUserDetailsManager(user, REDACTED);
    }
}
